...

{
    ...
    protected void filldropdownlist()
    {
        ...
        cmd = new MySqlCommand(productquery, sqlcon);
        ...
        //for supplier dropdownlist
            ...
            cmd = new MySqlCommand(supplierquery, sqlcon);
            da = new MySqlDataAdapter(cmd);
            ds = new DataSet();
            da.Fill(ds, "supplier");
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        if (sqlcon.State == ConnectionState.Closed)
            sqlcon.Open();
        MySqlCommand sqlcmd = new MySqlCommand("PurchaseCreateOrUpdate", sqlcon);
    ...
    void FillGridView()
    {
        ...
        MySqlDataAdapter sqlDa = new MySqlDataAdapter("ViewPurchaseGrid", sqlcon);
    ...
    protected void btndelete_Click(object sender, EventArgs e)
    {
        if (sqlcon.State == ConnectionState.Closed)
            sqlcon.Open();
        MySqlCommand cmd = new MySqlCommand("PurchaseDeleteById", sqlcon);
    ...
    protected void lnk_onClick(object sender, EventArgs e)
    {
        ...
        if (sqlcon.State == ConnectionState.Closed)
            sqlcon.Open();
        MySqlDataAdapter sqlDa = new MySqlDataAdapter("PurchaseViewById", sqlcon);
        sqlDa.SelectCommand.CommandType = CommandType.StoredProcedure;
