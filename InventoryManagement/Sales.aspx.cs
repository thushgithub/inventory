...

{
    ...
    {
        string sqlcon = "server=127.0.0.1;uid=root;pwd=;database=pipds";
        ...
        daAd = new MySqlDataAdapter(str, sqlcon);
        datbl = new DataTable();
        daAd.Fill(datbl);
    ...
    protected void SaveSell()
    {
        ...
        MySqlCommand cmd1 = new MySqlCommand(insertquery, sqlcon);
