...
public partial class Supplier : System.Web.UI.Page
{
    ...
    void FillGridView()
    {
        if (sqlcon.State == ConnectionState.Closed)
            sqlcon.Open();
        MySqlDataAdapter sqlDa = new MySqlDataAdapter("SupplierViewAll", sqlcon);
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        if (sqlcon.State == ConnectionState.Closed)
            sqlcon.Open();
        MySqlCommand sqlcmd = new MySqlCommand("SupplierCreateOrUpdate", sqlcon);
    ...
    protected void lnk_onClick(object sender, EventArgs e)
    {
        ...
        if (sqlcon.State == ConnectionState.Closed)
            sqlcon.Open();
        MySqlDataAdapter sqlDa = new MySqlDataAdapter("SupplierViewById", sqlcon);
        sqlDa.SelectCommand.CommandType = CommandType.StoredProcedure;
    ...
    protected void btndelete_Click(object sender, EventArgs e)
    {
        if (sqlcon.State == ConnectionState.Closed)
            sqlcon.Open();
        MySqlCommand sqlcmd = new MySqlCommand("SupplierDeleteById", sqlcon);
        sqlcmd.CommandType = CommandType.StoredProcedure;
